...
public class ModifyWSComponent {
	/*public String AddComp(String name,String url,String info,String maker,String userName,String org) throws NumberFormatException, SQLException
	{
		...
		if(userid!="")
		{
		    ...
		    " comp_id, comp_name, comp_maker, comp_url, comp_info, makerid, makedate, home, provider, business, center )"+
		    " VALUES ('"+ck.getKey()+"','"+name+"', '"+maker+"', '"+url+"',  '"+info+"',  '"+userid+"', '"+temp_str+"', '"+home+"', '"+provider+"', '"+business+"', '"+center+"')";
