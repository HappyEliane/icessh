...
public class FaultMenu {
	...
	public String ChangeMenu(String menu) throws NumberFormatException, SQLException
	{
		...
		getComp(menu);
		String sql="UPDATE ices_menu SET menu = '"+menu+"' "+" WHERE menu_id = 'MENU0004'";
		DB db=new DB();
	...
	public void getComp(String menu) throws NumberFormatException, SQLException
	{
		...
		String q="";
			q="ices_menu_comp where menuid='MENU0004'";
		sql+=q;
		DB db=new DB();
		ResultSet rs=db.query(sql);
	...
	{
		String sql="delete from ices_menu_comp where menuid='MENU0004' and (";
	...
	public String getServiceMenu()
	{
			...
			DB db=new DB();
			String sql="select * from ices_menu where menu_id='MENU0004'";
			ResultSet rs1=db.query(sql);
			String menu="";
			try {
